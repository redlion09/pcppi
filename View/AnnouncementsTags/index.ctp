<div class="announcementsTags index">
	<h2><?php echo __('Announcements Tags');?></h2>
	...
	<tr>
		<td><?php echo h($announcementsTag['AnnouncementsTag']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $announcementsTag['AnnouncementsTag']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $announcementsTag['AnnouncementsTag']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $announcementsTag['AnnouncementsTag']['id']), null, __('Are you sure you want to delete # %s?', $announcementsTag['AnnouncementsTag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
